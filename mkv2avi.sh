...
-ovc xvid -xvidencopts bitrate=950:vhq=4:chroma_me:chroma_opt:hq_ac:\
trellis:bvhq=1:bquant_ratio=162:bquant_offset=0:packed:quant_type=h263:\
lumi_mask:threads=0:pass=1:turbo \
...
mencoder $1 -vf hue=0:1.2,scale=704:396:param=3,unsharp=c3x3:0.5:l3x3:0.2,\
hqdn3d,fixpts=fps=24000/1001,ass,fixpts -ass -sws 9 -noskip \
-ovc xvid -xvidencopts bitrate=950:vhq=4:chroma_me:chroma_opt:\
...
kfthreshold=1:kfreduction=20:lumi_mask:threads=0:pass=2 \
