...
mencoder $1 -vf scale=704:396:param=3,unsharp=c3x3:0.5:l3x3:0.2,\
hqdn3d,eq=0:5,fixpts=fps=24000/1001,ass,fixpts -ass -sws 9 -noskip \
-ovc xvid -xvidencopts bitrate=-175000:vhq=4:chroma_me:chroma_opt:hq_ac:\
...
mencoder $1 -vf scale=704:396:param=3,unsharp=c3x3:0.5:l3x3:0.2,\
hqdn3d,eq=0:5,fixpts=fps=24000/1001,ass,fixpts -ass -sws 9 -noskip \
-ovc xvid -xvidencopts bitrate=-175000:vhq=4:chroma_me:chroma_opt:\
