...
mencoder.exe %1 -vf scale=704:396:param=3,unsharp=c3x3:0.5:l3x3:0.2,hqdn3d,eq=0:5,fixpts=fps=24000/1001,ass,fixpts -ass -sws 9 -noskip -ovc xvid -xvidencopts bitrate=-175000:vhq=4:chroma_me:chroma_opt:hq_ac:trellis:bvhq=1:bquant_ratio=162:bquant_offset=0:packed:quant_type=h263:lumi_mask:threads=2:pass=1:turbo -nosound -ofps 24000/1001 -o null

::Elimina null, el archivo de salida de la primer pasada.
del null
